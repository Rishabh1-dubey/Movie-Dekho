  ...
  return (
    <div className="w-[20%] h-full bg-slate-600 border-r-2  	">
      <h1 className=" font-bold text-xl  p-3">
        <i class="text-[35px] text-[#B838AF] ri-movie-fill  "></i>
      ...
      <nav className="  flex flex-col p-6 gap-3">
        ...
        <Link className=" text-slate-300 hover:bg-[#b838af] rounded-lg hover:text-white duration-300 p-4">
          <i class="ri-fire-fill v"></i> Trending
        </Link>

        <Link className="  text-slate-300 text-slate-300e hover:bg-[#b838af] rounded-lg hover:text-white duration-300 p-4">
          <i class="ri-sparkling-line mr-2"></i>Popular
        </Link>

        <Link className=" text-slate-300 hover:bg-[#b838af] rounded-lg hover:text-white duration-300 p-4">
          <i class="ri-film-line mr-2"></i>Movies
        </Link>
        <Link className=" text-slate-300 hover:bg-[#b838af] rounded-lg hover:text-white duration-300 p-4">
          <i class="ri-tv-fill mr-2"></i>TV Shows
        </Link>
        <Link className=" text-slate-300 hover:bg-[#b838af] rounded-lg hover:text-white duration-300 p-4">
          <i class="ri-user-line mr-2"></i> People
        </Link>
        ...
        <Link className=" text-slate-300 hover:bg-[#b838af] rounded-lg hover:text-white duration-300 p-4">
          <i class="ri-pages-line"></i> About Us
        </Link>
        <Link className=" text-slate-300 hover:bg-[#b838af] rounded-lg hover:text-white duration-300 p-4">
